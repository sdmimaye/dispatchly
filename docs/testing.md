...
PostgreSQL tests use Testcontainers and require Docker. They live in `Dispatchly.Transport.PostgreSql.Tests`. SQL Server tests do the same in `Dispatchly.Transport.SqlServer.Tests`. There is no shared testing assembly.
