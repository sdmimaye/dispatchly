...
`Dispatchly.Core` owns the message catalog and creates one dependency-injection scope per delivery. Transports publish and acknowledge. They do not reference each other. Registering a second transport throws.
