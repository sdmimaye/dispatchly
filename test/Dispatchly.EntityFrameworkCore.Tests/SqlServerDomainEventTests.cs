...
public sealed class SqlServerDomainEventTests
{
    private readonly SqlServerFixture _fixture;

    public SqlServerDomainEventTests(SqlServerFixture fixture) => _fixture = fixture;
    ...
    private async Task CreateOrdersTableAsync(IHost host)
    {
        ...
        await using var command = new SqlCommand(
            $"""
            CREATE TABLE {Quote(schema)}.{Quote("orders")} (
